...
{		
	...
	// SAR: Initialize buttons
	  HWREG(GPIO_PORTF_BASE+GPIO_O_LOCK) = GPIO_LOCK_KEY;
    HWREG(GPIO_PORTF_BASE+GPIO_O_CR) |= GPIO_PIN_0;
		GPIOPinTypeGPIOInput(GPIO_PORTF_BASE, GPIO_PIN_4); // sw1 as an input 
	  GPIOPinTypeGPIOInput(GPIO_PORTF_BASE, GPIO_PIN_0); // sw2 as an input 
		GPIOPadConfigSet(GPIO_PORTF_BASE,GPIO_PIN_0 | GPIO_PIN_4, GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPU); // weak pull-up 
